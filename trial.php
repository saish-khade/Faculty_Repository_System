...
<html>
   ...
   <body>
      <div class="box">
         ...
         <form method="post" action="connection1.php" enctype="multipart/form-data" autocomplete="on" class="formLayout">
            ...
            <div align="center" class="formGroup" style="text-align:left">
