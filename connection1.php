...
echo "Thank you for joining with us!<br>";
// Create database
...
try {
    ...
    VALUES ('$fname','$ptitle','$startDate','$journal','$national','$jname','$cindex','$hindex','$filename')";
    // use exec() because no results are returned
    $conn->exec($sql);
    echo "Your data is recorded successfully!!<br>Have a nice day!!!";
    }
catch(PDOException $e)
    {
    echo $sql . "<br>" . $e->getMessage();
